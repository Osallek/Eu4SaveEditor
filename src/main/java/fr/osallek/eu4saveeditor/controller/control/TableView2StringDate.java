...
public class TableView2StringDate extends TableView<StringDate> {
    ...
    public TableView2StringDate(Save save, ObservableList<StringDate> stringDates, boolean dateEditable, LocalDate startDate, LocalDate endDate) {
        TableColumn<StringDate, String> name = new TableColumn<>(save.getGame().getLocalisation("NAME"));
        ...
        TableColumn<StringDate, LocalDate> date = new TableColumn<>(save.getGame().getLocalisationCleanNoPunctuation("FE_STARTING_DATE"));
