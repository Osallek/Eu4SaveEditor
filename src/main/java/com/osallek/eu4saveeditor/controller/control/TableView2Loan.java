...
public class TableView2Loan extends TableView<Loan> {
    ...
    public TableView2Loan(Country country, ObservableList<Loan> loans) {
        TableColumn<Loan, Integer> amount = new TableColumn<>(country.getSave().getGame().getLocalisation("LOAN_MONEY"));
        ...
        TableColumn<Loan, Double> interest = new TableColumn<>(country.getSave().getGame().getLocalisationCleanNoPunctuation("EXPENSEINTEREST"));
        ...
        TableColumn<Loan, LocalDate> expiryDate = new TableColumn<>(country.getSave().getGame().getLocalisationCleanNoPunctuation("EXPIRES_ON"));
